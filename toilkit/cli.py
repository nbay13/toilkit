...
def main():
    ...
    parser_fastq_merge = subparsers.add_parser('fastq-merge')
    ...
    parser_rename_by_key = subparsers.add_parser('fastq-rename')
    ...
    parser_bbduk_bbseal = subparsers.add_parser('bbseal')
    ...
    parser_cat_bbseal = subparsers.add_parser('bbcat')
    ...
    parser_gather_bbseal_metrics = subparsers.add_parser('bbmetrics')
    ...
    parser_make_manifest = subparsers.add_parser('make-manifest')
    ...
    parser_cut_manifest = subparsers.add_parser('cut-manifest')
    ...
    parser_batch_rename_TOIL_FAIL = subparsers.add_parser('toil-fix')
    ...
    parser_process_uuid_tars = subparsers.add_parser('toil-combine')
