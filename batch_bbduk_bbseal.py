...
parser.add_argument('--bbdukdir', help='The directory containing bbduk.sh')
parser.add_argument('--bbsealdir', help='The directory containing bbseal.sh')
...
with open('filenames.txt', 'r') as f:
    for p in f.readlines():
        ...
        subprocess.run([bbduk, f'in1={p}_R1.fastq.gz', f'in2={p}_R2.fastq.gz', f'out1={p}_R1.trim.fq', f'out2={p}_R2.trim.fq', 'ref=~/bbmap/resources/trim_galore_adapter.fa', 'ktrim=r', 'k=10', 'mink=7', 'hdist=1', 'tpe', 'tbo'])
        subprocess.run([bbseal, f'in={p}_R#.trim.fq', f'pattern={p}_out_%_#.fq.gz', f'outu={p}_unmapped_#.fq.gz', 'ambig=all', 'ref=/media/graeberlab/wdgold/nbayley/refs/gencode.v31.transcripts.fa.gz,/media/graeberlab/wdgold/nbayley/refs/gencode.vM22.transcripts.fa.gz', f'refstats={p}_refstats.txt', 'refnames=t', 'overwrite=t', 'k=16'])
